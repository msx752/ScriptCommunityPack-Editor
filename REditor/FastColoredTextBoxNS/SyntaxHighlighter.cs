...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        protected Regex vSCPAttributeRegex;
        protected Regex vSCPCommentRegex;
        protected Regex vSCPKeywordRegex;
        protected Regex vSCPKeywordRegex2;
        protected Regex vSCPKeywordRegex3;
        protected Regex vSCPOperatorRegex;
        protected Regex vSCPStringRegex;
        protected Regex vSCPTriggerRegex;
        protected Regex vSCPTriggerSymbolRegex;
        protected Regex vSCPVariablesRegex;
        ...
        public virtual void HighlightSyntax(Language language, Range range)
        {
            switch (language)
            {
                ...
                case Language.Lua:
                    ...
                    break;
                case Language.Scp:
                    ScpSyntaxHighlight(range);
                    break;
                default:
                    //if (MAIN.WriteLog != null)
                    //    MAIN.WriteLog("HighlightSyntax", MAIN.LoggerType.Error);
                    break;
            }
        }
        public readonly Style styScpStrings = new TextStyle(Brushes.Brown, null, FontStyle.Italic);
        public readonly Style styScpComments = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly Style styScpAttributes = new TextStyle(Brushes.DarkCyan, null, FontStyle.Regular);
        public readonly Style styScpVariables = new TextStyle(Brushes.Cyan, null, FontStyle.Regular);
        public readonly Style styScpKeywords1 = new TextStyle(Brushes.Yellow, null, FontStyle.Regular);
        public readonly Style styScpKeywords2 = new TextStyle(Brushes.DarkCyan, null, FontStyle.Regular);
        public readonly Style styScpKeywords3 = new TextStyle(Brushes.Black, null, FontStyle.Bold);
        public readonly Style styScpOperators = new TextStyle(Brushes.Olive, null, FontStyle.Regular);
        public readonly Style styScpTriggers = new TextStyle(Brushes.DarkViolet, null, FontStyle.Regular);
        public readonly Style styScpTriggerSymbols =new TextStyle(Brushes.DarkViolet, null, FontStyle.Regular);
        /// <summary>
        /// Highlights Lua code
        /// </summary>
        ...
        {
            vSCPCommentRegex = new Regex("//.*$", RegexOptions.Multiline | RegexCompiledOption);
            vSCPStringRegex = new Regex("\"\"|@\"\"|''|@\".*?\"|(?<!@)(?<range>\".*?[^\\\\]\")|'.*?[^\\\\]'", RegexCompiledOption);
            vSCPAttributeRegex = new Regex(@"(?<range>(\[\w+\s+\w+(\s+\w+)?\]))", RegexOptions.Multiline | RegexCompiledOption);
            vSCPVariablesRegex = new Regex(@"\b((?i)uid|(?i)src|(?i)tag|(?i)tag0|(?i)ctag|(?i)ctag0|(?i)var|(?i)var0|(?i)local|(?i)float|(?i)ref\d+|(?i)def|(?i)def0|(?i)act|(?i)targ|(?i)serv|(?i)new|(?i)cont|(?i)list|(?i)obj|(?i)topobj|(?i)account|(?i)region|(?i)sector|(?i)link|(?i)findlayer|(?i)findcont|(?i)findid|(?i)findtype|(?i)file|(?i)db)\.+(?<range>\w+?)\b", RegexCompiledOption);
            vSCPTriggerRegex = new Regex(@"\@+(?<range>\w+?)\b", RegexCompiledOption);
            vSCPKeywordRegex = new Regex(@"\b((?i)[i,ı]f|(?i)el[i,ı]f|(?i)else[i,ı]f|(?i)end[i,ı]f|(?i)for|(?i)forcharlayer|(?i)forcharmemorytype|(?i)forchars|(?i)forclients|(?i)forcont|(?i)forcontid|(?i)forconttype|(?i)forinstances|(?i)foritems|(?i)forobjs|(?i)forplayers|(?i)endfor|(?i)wh[i,ı]le|(?i)endwh[i,ı]le|(?i)beg[i,ı]n|(?i)end|(?i)dorand|(?i)dosw[i,ı]tch|(?i)enddo|(?i)return|(?i)else|(?i)eval|(?i)floatval|(?i)qval|(?i)uval|(?i)fval|(?i)feval|(?i)fhval|(?i)hval|(?i)try|(?i)tryp|(?i)trysrc|(?i)trysrv|(?i)argn|(?i)argn\d+|(?i)args|(?i)argo|(?i)argv|(?i)strcmp|(?i)strcmpi|(?i)strindexof|(?i)strlen|(?i)strmatch|(?i)strregex|(?i)flags|(?i)button|(?i)buttontileart|(?i)checkbox|(?i)checkertrans|(?i)croppedtext|(?i)dcroppedtext|(?i)dorigin|(?i)dhtmlgump|(?i)dtext|(?i)dtextentry|(?i)dtextentrylimited|(?i)group|(?i)gumppic|(?i)gumppictiled|(?i)htmlgump|(?i)noclose|(?i)nodispose|(?i)nomove|(?i)page|(?i)radio|(?i)resizepic|(?i)text|(?i)textentry|(?i)textentrylimited|(?i)tilepic|(?i)tilepichue|(?i)tooltip|(?i)xmfhtmlgump|(?i)xmfhtmlgumpcolor|(?i)xmfhtmltok|(?i)argchk|(?i)argchkid|(?i)argtxt)\b|//(?i)region\b|//(?i)endregion\b", RegexCompiledOption);
            vSCPKeywordRegex2 = new Regex(@"\b((?i)uid|(?i)src|(?i)tag|(?i)tag0|(?i)ctag|(?i)ctag0|(?i)var|(?i)var0|(?i)local|(?i)float|(?i)ref\d+|(?i)def|(?i)def0|(?i)act|(?i)targ|(?i)serv|(?i)new|(?i)cont|(?i)list|(?i)obj|(?i)topobj|(?i)account|(?i)region|(?i)sector|(?i)link|(?i)findlayer|(?i)findcont|(?i)findid|(?i)findtype|(?i)file|(?i)db)\b", RegexCompiledOption);
            vSCPKeywordRegex3 = new Regex(@"\-\s(?i)Author\b\:|\-\s(?i)Contributors\b\:|\-\s(?i)Last edited by\b\:|\-\s(?i)Script last updated\b\:|\-\s(?i)Language\b\:|\-\s(?i)Script version\b\:", RegexCompiledOption);
            vSCPOperatorRegex = new Regex(@"\<|\>|\[|\]|\(|\)|{|}", RegexCompiledOption);
            vSCPTriggerSymbolRegex = new Regex(@"\@", RegexCompiledOption);
        }
        /// <summary>
        ...
        public void InitStyleSchema(Language lang)
        {
            switch (lang)
            {
                ...
                case Language.SQL:
                    ...
                    break;
                case Language.Scp:
                    //I DONT USE HERE (NOT YET- UNNECESSARY)
                    break;

                default:

                    //MAIN.WriteLog("InitStyleSchema", MAIN.LoggerType.Error);
                    break;
            }
        }
