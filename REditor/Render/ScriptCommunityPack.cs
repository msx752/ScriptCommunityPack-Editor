...
namespace FastColoredTextBoxNS.Render
{
    public class ScriptCommunityPack
    {
        ...
        public static T[] loadKwCommand<T>(PropertyTypes typ) where T : AutoCompleteItem
        {
            ...
            ppti = keywordsInformation.FindAll(p => p.Properties.Contains(typ));
            T[] mto = new T[ppti.Count];
        ...
        {
            List<PopupToolTip> ppti = new List<PopupToolTip>();
            ppti = keywordsInformation.FindAll(p => !p.Properties.Contains(ignoreList[0]));
            for (int i = 1; i < ignoreList.Length; i++)
                ppti = ppti.FindAll(p => !p.Properties.Contains(ignoreList[i]));
        ...
        public static void LoadKeywords()
        {
            ...
            keywordsInformation.Add(new PopupToolTip() { Name = "@AfterClick", Parameters = "", Comment = " Fires when the object has been single-clicked, just before the overhead name is shown.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Attack", Parameters = "", Comment = " Fires when the Mobile begins attacking another.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@CallGuards", Parameters = "", Comment = " Fires when the Mobile calls for guards.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@CharAttack", Parameters = "", Comment = " Fires when the Mobile is attacked by another character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@CharClick", Parameters = "", Comment = " Fires when the Mobile is clicked by another character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@CharClientTooltip", Parameters = "", Comment = " Fires when the tooltips are about to be sent to the character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@CharDClick", Parameters = "", Comment = " Fires when the Mobile double clicks another character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@CharTradeAccepted", Parameters = "", Comment = " Fires when another Mobile accepts trade with the character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Click", Parameters = "", Comment = " Fires when the object has been single-clicked.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ClientTooltip", Parameters = "", Comment = " Fires when tooltips for this Mobile are about to be sent to a client.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ContextMenuRequest", Parameters = "", Comment = " Fires when a client requests the context menu options for the object.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ContextMenuSelect", Parameters = "", Comment = " Fires when a client selects a context menu option for the object.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Create", Parameters = "", Comment = " Fires when the object is initially created, before it is placed in the world.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Criminal", Parameters = "", Comment = " Fires when the Mobile becomes a criminal.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@DClick", Parameters = "", Comment = " Fires when the object is double-clicked.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Death", Parameters = "", Comment = " Fires when the character's hitpoints reaches zero.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@DeathCorpse", Parameters = "", Comment = " Fires when a corpse is created for the character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Destroy", Parameters = "", Comment = " Fires when the object is being deleted.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Dismount", Parameters = "", Comment = " Fires when the Mobile dismounts their ride.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@EnvironChange", Parameters = "", Comment = " Fires when the environment changes for the character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ExpChange", Parameters = "", Comment = " Fires when the character's experience points change.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ExpLevelChange", Parameters = "", Comment = " Fires when the character's experience level changes.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@FameChange", Parameters = "", Comment = " Fires when the character's fame changes.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@GetHit", Parameters = "", Comment = " Fires when the Mobile receives damage.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Hit", Parameters = "", Comment = " Fires when the Mobile hits another in combat.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@HitMiss", Parameters = "", Comment = " Fires when the Mobile fails to hit another in combat.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@HouseDesignCommit", Parameters = "", Comment = " Fires when the Mobile commits a new house design.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@HouseDesignExit", Parameters = "", Comment = " Fires when the Mobile exits house design mode.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Hunger", Parameters = "", Comment = " Fires when the character's food level decreases.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemAfterClick", Parameters = "", Comment = " Fires when the Mobile single-clicks an item, just before the overhead name is shown.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemBuy", Parameters = "", Comment = " Fires when the Mobile buys an item from a vendor.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemClick", Parameters = "", Comment = " Fires when the Mobile single-clicks an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemClientTooltip", Parameters = "", Comment = " Fires when the tooltips are about to be sent to the client for an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemContextMenuRequest", Parameters = "", Comment = " Fires when the Mobile requests the context menu options for an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemContextMenuSelect", Parameters = "", Comment = " Fires when the Mobile selects a context menu option for an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemCreate", Parameters = "", Comment = " Fires when an item is initially created, before it is placed in the world, and the Mobile is in some way responsible for it.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemDamage", Parameters = "", Comment = " Fires when the Mobile damages an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemDClick", Parameters = "", Comment = " Fires when the Mobile double-clicks an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemDropOn_Char", Parameters = "", Comment = " Fires when the Mobile drops an item on to a character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemDropOn_Ground", Parameters = "", Comment = " Fires when the Mobile drops an item on to the ground.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemDropOn_Item", Parameters = "", Comment = " Fires when the Mobile drops an item on to another item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemDropOn_Self", Parameters = "", Comment = " Fires when the Mobile drops an item inside another item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemEquip", Parameters = "", Comment = " Fires when the Mobile equips an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemEquipTest", Parameters = "", Comment = " Fires when the characer is about to equip an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemPickUp_Ground", Parameters = "", Comment = " Fires when the Mobile picks an item up from the ground.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemPickUp_Pack", Parameters = "", Comment = " Fires when the Mobile picks an item up from inside a container.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemPickUp_Self", Parameters = "", Comment = " Fires when the Mobile picks an item up from inside another item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemPickUp_Stack", Parameters = "", Comment = " Fires when the Mobile picks up an item from a stack.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemSell", Parameters = "", Comment = " Fires when the Mobile sells an item to a vendor.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemSpellEffect", Parameters = "", Comment = " Fires when the Mobile hits an item with a spell.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemStep", Parameters = "", Comment = " Fires when the Mobile steps on an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemTargOn_Cancel", Parameters = "", Comment = " Fires when the Mobile cancels an item's target cursor.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemTargOn_Char", Parameters = "", Comment = " Fires when the Mobile targets a Mobile with an item's target cursor.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemTargOn_Ground", Parameters = "", Comment = " Fires when the Mobile targets the ground with an item's target cursor.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemTargOn_Item", Parameters = "", Comment = " Fires when the Mobile targets an item with an item's target cursor.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemToolTip", Parameters = "", Comment = " Fires when the Mobile requests old-style tooltips for an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ItemUnEquip", Parameters = "", Comment = " Fires when the Mobile unequips an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Jailed", Parameters = "", Comment = " Fires when the Mobile is sent to jail.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@KarmaChange", Parameters = "", Comment = " Fires when the character's karma changes.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Kill", Parameters = "", Comment = " Fires when the Mobile kills another character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Login", Parameters = "", Comment = " Fires when the Mobile logs in.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Logout", Parameters = "", Comment = " Fires when the Mobile logs out.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Mount", Parameters = "", Comment = " Fires when the Mobile mounts a ride.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@MurderDecay", Parameters = "", Comment = " Fires when one of the character's kills is about to decay.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@MurderMark", Parameters = "", Comment = " Fires when the Mobile is about to gain a kill.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCAcceptItem", Parameters = "", Comment = " Fires when the NPC receives an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCActFight", Parameters = "", Comment = " Fires when the NPC makes a combat decision.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCActFollow", Parameters = "", Comment = " Fires when the NPC follows another character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCAction", Parameters = "", Comment = " Fires when the NPC is about to perform an AI action.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCHearGreeting", Parameters = "", Comment = " Fires when the NPC hears a Mobile for the first time.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCHearUnknown", Parameters = "", Comment = " Fires when the NPC hears something they don't understand.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCLookAtChar", Parameters = "", Comment = " Fires then the NPC looks at a character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCLookAtItem", Parameters = "", Comment = " Fires when the NPC looks at an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCLostTeleport", Parameters = "", Comment = " Fires when the NPC is lost and is about to be teleported back to their HOME.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCRefuseItem", Parameters = "", Comment = " Fires when the NPC refuses an item being given to them.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCRestock", Parameters = "", Comment = " Fires when the NPC is having their items restocked.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCSeeNewPlayer", Parameters = "", Comment = " Fires when the NPC first sees a player.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCSeeWantItem", Parameters = "", Comment = " Fires when the NPC sees an item they want.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@NPCSpecialAction", Parameters = "", Comment = " Fires when the NPC is about to perform a special action (leaving fire trail, dropping web).", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@PersonalSpace", Parameters = "", Comment = " Fires when the Mobile is stepped on.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@PetDesert", Parameters = "", Comment = " Fires when the Mobile deserts its owner.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Profile", Parameters = "", Comment = " Fires when a player attempts to read the character's profile from the paperdoll.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ReceiveItem", Parameters = "", Comment = " Fires when the NPC receives an item from another character, before they decide if they want it or not.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@RegionEnter", Parameters = "", Comment = " Fires when the Mobile enters a region.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@RegionLeave", Parameters = "", Comment = " Fires when the Mobile leaves a region.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Rename", Parameters = "", Comment = " Fires when the Mobile renames another.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SeeCrime", Parameters = "", Comment = " Fires when the Mobile sees a crime take place.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillAbort", Parameters = "", Comment = " Fires when the Mobile aborts a skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillChange", Parameters = "", Comment = " Fires when the character's skill level changes.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillFail", Parameters = "", Comment = " Fires when the Mobile fails a skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillGain", Parameters = "", Comment = " Fires when the Mobile has a chance to gain in a skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillMakeItem", Parameters = "", Comment = " Fires when the Mobile crafts an item.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillMenu", Parameters = "", Comment = " Fires when a skill menu is shown to the character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillPreStart", Parameters = "", Comment = " Fires when the Mobile starts a skill, before any hardcoded action takes place.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillSelect", Parameters = "", Comment = " Fires when the Mobile selects a skill on their skill menu.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillStart", Parameters = "", Comment = " Fires when the Mobile starts a skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillSuccess", Parameters = "", Comment = " Fires when the Mobile succeeds at a skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SkillUseQuick", Parameters = "", Comment = " Fires when the Mobile quickly uses a skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SpellBook", Parameters = "", Comment = " Fires when the Mobile opens their spellbook.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SpellCast", Parameters = "", Comment = " Fires when the Mobile casts a spell.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SpellEffect", Parameters = "", Comment = " Fires when the Mobile is hit by the effects of a spell.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SpellFail", Parameters = "", Comment = " Fires when the Mobile fails to cast a spell.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SpellSelect", Parameters = "", Comment = " Fires when the Mobile selects a spell to cast.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@SpellSuccess", Parameters = "", Comment = " Fires when the Mobile successfully casts a spell.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@StatChange", Parameters = "", Comment = " Fires when the character's STR, DEX or INT is changed through skill gain.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@StepStealth", Parameters = "", Comment = " Fires when the Mobile takes a step whilst hidden.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ToolTip", Parameters = "", Comment = " Fires when a player requests old-style tooltips for this character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@TradeAccepted", Parameters = "", Comment = " Fires when the Mobile accepts a trade with another player.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserBugReport", Parameters = "", Comment = " Fires when the player submits a bug report.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserChatButton", Parameters = "", Comment = " Fires when the player presses the Chat button on the paperdoll.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserExtCmd", Parameters = "", Comment = " Fires when the player sends an extended command packet. (used by some macros)", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserExWalkLimit", Parameters = "", Comment = " Fires when the player's movement is restricted by the movement speed settings in Sphere.ini", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserGuildButton", Parameters = "", Comment = " Fires when the player presses the Guild button on the paperdoll.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserKRToolbar", Parameters = "", Comment = " Fires when the player presses a button on the toolbar.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserMailBag", Parameters = "", Comment = " Fires when the player drags the mail bag on to another character.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserQuestArrowClick", Parameters = "", Comment = " Fires when the player clicks the quest arrow.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserQuestButton", Parameters = "", Comment = " Fires when the player presses the Quest button on the paperdoll.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserSkills", Parameters = "", Comment = " Fires when the player opens their skill menu, or a skill update is sent to the player.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserSpecialMove", Parameters = "", Comment = " Fires when the player uses a special move.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserStats", Parameters = "", Comment = " Fires when the player opens the status window.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserVirtue", Parameters = "", Comment = " Fires when the player presses on the Virtue button.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserVirtueInvoke", Parameters = "", Comment = " Fires when the player invokes a virtue through macros.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UserWarmode", Parameters = "", Comment = " Fires when the player switches between war and peace mode.", Properties = new List<PropertyTypes>() { PropertyTypes.Mobile, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Buy", Parameters = "", Comment = " Fires when the item is being bought from a vendor.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Damage", Parameters = "", Comment = " Fires when the item receives damage.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@DropOn_Char", Parameters = "", Comment = " Fires when the item has been dropped on to a character.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@DropOn_Ground", Parameters = "", Comment = " Fires when the item has been dropped on to the ground.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@DropOn_Item", Parameters = "", Comment = " Fires when the item is dropped on to another item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@DropOn_Self", Parameters = "", Comment = " Fires when an item has been dropped on to this item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Equip", Parameters = "", Comment = " Fires when the item has been equipped.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@EquipTest", Parameters = "", Comment = " Fires when the item is about to be equipped.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@PickUp_Ground", Parameters = "", Comment = " Fires when the item ihas been picked up from the ground.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@PickUp_Pack", Parameters = "", Comment = " Fires when the item is picked up from inside a container.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@PickUp_Self", Parameters = "", Comment = " Fires when an item has been picked up from inside the item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@PickUp_Stack", Parameters = "", Comment = " Fires when the item is picked up from a stack.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Sell", Parameters = "", Comment = " Fires when the item is sold to a vendor.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Step", Parameters = "", Comment = " Fires when a Mobile steps on the item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.Region, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@TargOn_Cancel", Parameters = "", Comment = " Fires when a target is cancelled from the item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@TargOn_Char", Parameters = "", Comment = " Fires when a Mobile is targeted from the item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@TargOn_Ground", Parameters = "", Comment = " Fires when the ground is targeted from the item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@TargOn_Item", Parameters = "", Comment = " Fires when an item is targeted from this item.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Timer", Parameters = "", Comment = " Fires when the item's timer expires.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UnEquip", Parameters = "", Comment = " Fires when the item is unequipped.", Properties = new List<PropertyTypes>() { PropertyTypes.Item, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ResourceTest", Parameters = "", Comment = " Fires when the resource is being considered for spawning.", Properties = new List<PropertyTypes>() { PropertyTypes.Region, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@ResourceFound", Parameters = "", Comment = " Fires when the resource is spawned.", Properties = new List<PropertyTypes>() { PropertyTypes.Region, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@CliPeriodic", Parameters = "", Comment = " Fires multiple times approximately every 30 seconds, for each client in the region.", Properties = new List<PropertyTypes>() { PropertyTypes.Region, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Enter", Parameters = "", Comment = " Fires when a Mobile enters the region.", Properties = new List<PropertyTypes>() { PropertyTypes.Region, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Exit", Parameters = "", Comment = " Fires when a Mobile exits the region.", Properties = new List<PropertyTypes>() { PropertyTypes.Region, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@RegPeriodic", Parameters = "", Comment = " Fires once approximately every 30 seconds, as long as there is at least one client in the region.", Properties = new List<PropertyTypes>() { PropertyTypes.Region, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Abort", Parameters = "", Comment = " Fires when a Mobile aborts an attempt at using the skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Fail", Parameters = "", Comment = " Fires when a Mobile fails an attempt at using the skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.Spell, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Gain", Parameters = "", Comment = " Fires when a Mobile is given the chance to gain in the skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@PreStart", Parameters = "", Comment = " Fires when a Mobile starts to use the skill, before any hardcoded behaviour takes place.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Select", Parameters = "", Comment = " Fires when a Mobile selects the skill from their skill menu.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.Spell, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Start", Parameters = "", Comment = " Fires when a Mobile starts to use the skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.Spell, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Success", Parameters = "", Comment = " Fires when a Mobile succeeds an attempt at using the skill.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.Spell, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@UseQuick", Parameters = "", Comment = " Fires when a Mobile quickly uses the skill, without changing their ACTION.", Properties = new List<PropertyTypes>() { PropertyTypes.Skills, PropertyTypes.TriggerAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "@Effect", Parameters = "", Comment = " Fires when a Mobile or item is hit by the spell.", Properties = new List<PropertyTypes>() { PropertyTypes.Spell, PropertyTypes.TriggerAuto } });
            ...
            keywordsInformation.Add(new PopupToolTip() { Name = "if (<^>)\n\nendif", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "if (<^>)\n\nelseif (<>)\n\nelse\n\nendif", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "for ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forcharlayer ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forcharmemorytype ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forchars ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forclients ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forplayers ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forcont ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forcontid ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forconttype ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forinstances ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "foritems ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "forobjs ^\n\nendfor", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "while (<^>)\n\nendwhile", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "begin\n^\nend", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "dorand ^\n\nenddo", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<eval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<floatval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<qval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<uval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<fval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<feval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<fhval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "<hval <^>>", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "strcmp(^)", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "strcmpi(^)", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "strindexof(^)", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "strlen(^)", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
            keywordsInformation.Add(new PopupToolTip() { Name = "strmatch(^)", Parameters = "", Comment = "", Properties = new List<PropertyTypes>() { PropertyTypes.SnippetAuto } });
        ...
        public static void ToolTip_Draw(object sender, DrawToolTipEventArgs e)
        {
        ...
        public static void ToolTip_Popup(object sender, PopupEventArgs e)
        {
            ToolTip tp = sender as ToolTip;
